...
int main(void)
{
    const struct CMUnitTest tests[] = {
        ...
        cmocka_unit_test(test_string_type_createFromBuffer),
        cmocka_unit_test(test_string_type_length),
        cmocka_unit_test(test_string_type_cStr),
        cmocka_unit_test(test_string_type_at),
        ...
        cmocka_unit_test(test_string_type_reserve),
